...
void AStrategyMiniMapCapture::BeginPlay()
{
	...
	if (!GetCaptureComponent2D()->TextureTarget || MiniMapWidth != GetCaptureComponent2D()->TextureTarget->GetSurfaceWidth() || MiniMapHeight != GetCaptureComponent2D()->TextureTarget->GetSurfaceHeight())
	{
	...
	if( MyGameState != nullptr ) { MyGameState->MiniMapCamera = this; }
