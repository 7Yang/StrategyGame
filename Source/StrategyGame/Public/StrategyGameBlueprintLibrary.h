...
class UStrategyGameBlueprintLibrary : public UBlueprintFunctionLibrary
{
	...
	static class AStrategyProjectile* SpawnProjectile(UObject* WorldContextObject, UBlueprint* ProjectileBlueprint, const FVector& SpawnLocation, const FVector& ShootDirection, TEnumAsByte<EStrategyTeam::Type> OwnerTeam, int32 ImpactDamage, float LifeSpan=10.0f, class AStrategyBuilding* InOwner = NULL);

	UFUNCTION(BlueprintCallable, Category=Game, meta=(WorldContext="WorldContextObject"))
	static class AStrategyProjectile* SpawnProjectileFromClass(UObject* WorldContextObject, TSubclassOf<class AStrategyProjectile> ProjectileClass, const FVector& SpawnLocation, const FVector& ShootDirection, TEnumAsByte<EStrategyTeam::Type> OwnerTeam, int32 ImpactDamage, float LifeSpan=10.0f, class AStrategyBuilding* InOwner = NULL);
	...
	static void GiveBuff(class AStrategyChar* InChar, int32 AttackMin = 5, int32 AttackMax = 10, int32 DamageReduction = 0, int32 MaxHealthBonus = 0, int32 HealthRegen = 10, float Speed = 0.0f, float Duration=30.0f, bool bInfiniteDuration=false, int32 AttackDistance = 10 );
